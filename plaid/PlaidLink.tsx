...
// Drop this anywhere you want a "Connect Bank" button
...
//   onSuccess={(name) => console.log(`${name} connected!`)}
// />
//
// Re-auth (expired token):
// <PlaidLinkButton
//   projectId="proj_abc123"
//   mode="update"
...
//
// Custom styled:
// <PlaidLinkButton projectId={id} className="btn btn-primary">
//   + Add Bank Account
// </PlaidLinkButton>
