...
export class StripeService {
  private getClient(secretKey: string): Stripe {
    return new Stripe(secretKey, { apiVersion: '2023-10-16', typescript: true })
  }
    ...
    await prisma.integration.upsert({
      ...
      update: {
        ...
        metadata: {
          ...
          balance: balance.available as any,
        },
        errorMessage: null,
      },
      create: {
    ...
    for (const refund of refunds.data) {
      await prisma.revenueEntry.upsert({
        ...
        create: {
          ...
          metadata: { chargeId: refund.charge as any, reason: refund.reason as any },
        },
      }).catch(() => { })
      count++
    }
